...
# Crée le répertoire de données s'il n'existe pas
    ...
    response.raise_for_status() # S'assure que la requête a réussi# Extraire le contenu du zip en mémoire
...
if __name__ == "__main__":
    ...
    # Enlevez.sample() pour utiliser le jeu de données completdata_df = load_and_prepare_data(dataset_url).sample(n=50000, random_state=42)
